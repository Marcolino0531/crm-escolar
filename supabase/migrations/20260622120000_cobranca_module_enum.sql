-- Novo módulo "Cobrança" (separado da Inadimplência).
--
-- Adiciona o valor 'cobranca' ao enum public.app_module. Em uma migration
...
-- que referenciam 'cobranca'::public.app_module ficam na migration seguinte.
--
...
ALTER TYPE public.app_module ADD VALUE IF NOT EXISTS 'cobranca';
