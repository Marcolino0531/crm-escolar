...
export function RotinaEscolar({
  ...
  return (
    <section className="space-y-5 rounded-lg border p-4">
      <div>
        <h2 className="font-medium">Rotina Escolar</h2>
        <p className="text-xs text-muted-foreground">
          Quando o aluno começa, em que horários fica no colégio e quais refeições são contratadas.
        </p>
      </div>
      ...
      {/* Horários por dia — os atalhos preenchem, mas os campos seguem livres. */}
      <div className="space-y-3">
            ...
            <div key={dia} className="space-y-2 rounded-md border p-3">
              ...
              <div className="flex flex-wrap gap-2">
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => definirHorario(dia, { ...MEIO_PERIODO_MANHA })}
                >
                  Meio período manhã
                </Button>
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => definirHorario(dia, { ...MEIO_PERIODO_TARDE })}
                >
                  Meio período tarde
                </Button>
              </div>
