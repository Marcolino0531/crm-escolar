// This file is automatically generated by `supabase gen types`. Do not edit it directly.
  ...
  public: {
    Tables: {
      ...
      funcionarios: {
        ...
        Relationships: [
          {
            foreignKeyName: "funcionarios_school_id_fkey";
            columns: ["school_id"];
            isOneToOne: false;
      ...
      onboarding: {
        ...
        Relationships: [
          {
            foreignKeyName: "onboarding_lead_id_fkey";
            columns: ["lead_id"];
            isOneToOne: false;
          ...
          {
            foreignKeyName: "onboarding_school_id_fkey";
            columns: ["school_id"];
            isOneToOne: false;
            referencedRelation: "schools";
            referencedColumns: ["id"];
